...
@Controller
@RequestMapping("/legacy/consumer")
@ConditionalOnProperty(name = "kafka.legacyConsumer.enabled", havingValue = "true", matchIfMissing = true)
public class LegacyConsumerController extends ConsumerController
{
